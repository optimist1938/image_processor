...
## Unit tests
Для самопроверки, я также написал юнит тесты. Чтобы проверить проект необходимо зайти в директорию `../unit_tests/build` и прописать следующие команды в терминале:
1. `cmake ..`
2. `cmake --build .`
3. `cd ..`
4. `build/unit_tests`
